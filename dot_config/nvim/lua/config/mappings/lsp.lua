return {
  dart = {
    ...
    { "<Localleader>fs", function() require("telescope").extensions.flutter.fvm() end, desc = " Flutter SDK (fvm)" },
  },
  -- TODO: Update this
  go = {
    { "<Localleader>g", group = " Go Tools" },
    { "<Localleader>gc", "<cmd>GoCmt<cr>", desc = " Generate comment" },
    { "<Localleader>ge", "<cmd>GoGet<cr>", desc = " Run go get" },
    { "<Localleader>gf", "<cmd>GoIfErr<cr>", desc = " Generate if err" },
    { "<Localleader>gg", "<cmd>GoGenerate<cr>", desc = " Go generate" },
    { "<Localleader>gi", "<cmd>GoImpl<cr>", desc = " Implement interace" },
    { "<Localleader>gm", "<cmd>GoMod <cr>", desc = " Run go mod" },
    { "<Localleader>gw", "<cmd>GoWork<cr>", desc = " Go work" },

    { "<Localleader>gt", group = "󰓹 Tags" },
    { "<Localleader>gta", "<cmd>GoTagAdd<cr>", desc = " Add yaml/json tag" },
    { "<Localleader>gtr", "<cmd>GoTagRm<cr>", desc = " Rm yaml/json tag" },
  ...
  rust = {
    ...
    { "<Localleader>rS", function() vim.cmd.RustLsp { "ssr" } end, desc = " Structural Search" },
